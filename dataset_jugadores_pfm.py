# -*- coding: utf-8 -*-
"""Dataset Jugadores PFM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10Dop-6W7H-qoJhM_BOJjWIFPcBS7YHEN
"""
...
"""# Similitud Jugadors (Reducción de dimensionalidad, según lanzamientos):

Es necesario cambiar el orden de las variables de cadenas de texto para poder separar correctamente el dataset. Para ello, voy a cambiar el orden sobre como estan colocadas las métricas para juntar todas las númericas en un grupo y las cadenas de texto en otro.
"""
